(function() {
  ...
  function ImageModalController(
    ...
    vm.shareWmsGetMap = imageId => {
      let bBox;
      let url = `${wmsRequestUrl}/wms?service=WMS&version=1.1.1&request=GetMap&layers=omar:raster_entry$filter=in(${imageId})&srs={proj}&width={width}&height={height}&transparent=true&format=image/png&bbox=`;
