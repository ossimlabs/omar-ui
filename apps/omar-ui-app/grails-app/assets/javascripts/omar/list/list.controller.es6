(function() {
  ...
  function ImageModalController(
    ...
    vm.shareWmsGetMap = imageId => {
      let bBox;
      let url = `${wmsRequestUrl}/wms?service=WMS&version=1.1.1&request=GetMap&layers=omar:raster_entry&filter=in(${imageId})&srs=EPSG:3857&width=256&height=256&transparent=true&format=image/png&bbox=`;
