...
Common labels
*/}}
{{- define "omar-ui.labels" -}}
omar-ui.sh/chart: {{ include "omar-ui.chart" . }}
{{ include "omar-ui.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "omar-ui.selectorLabels" -}}
app.kubernetes.io/name: {{ include "omar-ui.name" . }}
