(function() {
    'use strict';
    angular.module('omarApp').service('beNumberService', ['$rootScope', '$http', '$timeout', 'wfsService', beNumberService]);

    function beNumberService($rootScope, $http, $timeout, wfsService) {

        // console.log(AppO2.APP_CONFIG);
        // var beObj = [];
        // var placemarkConfig = AppO2.APP_CONFIG.params.misc.placemarks;
        // console.log('placemarkConfig: ', placemarkConfig);
        ...
        // console.log('beLookupEnabled: ', beLookupEnabled);
        // if (beLookupEnabled) {
        //
        //   // this.getBeData = function(geom) {
        //   //   wfsService.beSearch(geom).then(function(response){
