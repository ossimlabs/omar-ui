    ...
    .config(['$stateProvider', '$urlRouterProvider', '$uibTooltipProvider', '$logProvider',
      ...
      function ($stateProvider, $urlRouterProvider, $uibTooltipProvider, $logProvider) {
        ...
        $stateProvider
          ...
          .state('mapImage', {
            url: '/mapImage?filename=&entry_id=&width=&height&bands=&numOfBands=&imageId=&brightness=&contrast=&histOp=&histCenterTile=&resamplerFilter=&sharpenMode=&imageSpaceRequestUrl=&uiRequestUrl=&mensaRequestUrl=&wfsRequestUrl=&showModalSplash=',
