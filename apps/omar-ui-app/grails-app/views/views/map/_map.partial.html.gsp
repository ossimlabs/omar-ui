            ...
            <div class="media">
              <div class="media-left">
                <img ng-style="list.thumbBorder(image.properties.file_type)"
                  ...
                  ng-src="{{list.thumbPath}}?{{list.thumbFilename}}{{image.properties.filename}}{{list.thumbEntry}}{{image.properties.entry_id}}{{list.thumbSize}}{{list.thumbFormat}}{{list.outputRadiometry}}"
                  alt="Image thumbnail"
