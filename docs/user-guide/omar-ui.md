...
### User Authentication
All users are authenticated through PKI using their personal credentials. Use your certificate assigned to you to authenticate to the site. If you do not use your PKI certificate, you will be taken to a 404 error page. When properly authenticated, you should see your name in the top right hand corner under the classification banner. See properly authenticated user example below.
