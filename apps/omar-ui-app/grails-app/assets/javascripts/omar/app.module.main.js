    ...
    .config(['$stateProvider', '$urlRouterProvider', '$uibTooltipProvider',
      ...
      function ($stateProvider, $urlRouterProvider, $uibTooltipProvider) {
        ...
        $stateProvider
          ...
          .state('mapImage', {
            url: '/mapImage?filename=&entry_id=&width=&height&bands=&numOfBands=&imageId=&brightness=&contrast=&histOp=&histCenterTile=&resamplerFilter=&sharpenMode=&imageSpaceRequestUrl=&uiRequestUrl=&mensaRequestUrl',
