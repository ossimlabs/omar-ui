...
*/}}
{{- define "omar-ui.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-ui.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-ui.generateImagePullSecret" }}
