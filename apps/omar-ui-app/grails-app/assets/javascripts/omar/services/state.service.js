...
angular
  ...
  function stateService($rootScope, $timeout) {
    ...
    _this.updateSitesAppState = function(objParams) {
      ...
      _this.omarSitesState.info.name = checkForValidObjProp(_this.omarSitesState.info.name, objParams.infoName) ? objParams.infoName : _this.omarSitesState.info.name;

      _this.omarSitesState.info.description = checkForValidObjProp(_this.omarSitesState.info.description, objParams.infoDescription) ? objParams.infoDescription : _this.omarSitesState.info.description;

      _this.omarSitesState.url.uiContextPath = checkForValidObjProp(_this.omarSitesState.url.uiContextPath, objParams.urlUiContextPath) ? objParams.urlUiContextPath : _this.omarSitesState.url.uiContextPath;

      _this.omarSitesState.url.base = checkForValidObjProp(_this.omarSitesState.url.base, objParams.urlBase) ? objParams.urlBase : _this.omarSitesState.url.base;

      _this.omarSitesState.url.wfsContextPath = checkForValidObjProp(_this.omarSitesState.url.wfsContextPath, objParams.urlWfsContextPath) ? objParams.urlWfsContextPath : _this.omarSitesState.url.wfsContextPath;

      _this.omarSitesState.url.wmsContextPath = checkForValidObjProp(_this.omarSitesState.url.wmsContextPath, objParams.urlWmsContextPath) ? objParams.urlWmsContextPath : _this.omarSitesState.url.wmsContextPath;

      _this.omarSitesState.url.omsContextPath = checkForValidObjProp(_this.omarSitesState.url.omsContextPath, objParams.urlOmsContextPath) ? objParams.urlOmsContextPath : _this.omarSitesState.url.omsContextPath;

      _this.omarSitesState.url.geoscriptContextPath = checkForValidObjProp(_this.omarSitesState.url.geoscriptContextPath, objParams.urlGeoscriptContextPath) ? objParams.urlGeoscriptContextPath : _this.omarSitesState.url.geoscriptContextPath;

      _this.omarSitesState.url.avroMetadataContextPath = checkForValidObjProp(_this.omarSitesState.url.avroMetadataContextPath, objParams.urlAvroMetadataContextPath) ? objParams.urlAvroMetadataContextPath : _this.omarSitesState.url.avroMetadataContextPath;

      _this.omarSitesState.url.mensaContextPath = checkForValidObjProp(_this.omarSitesState.url.mensaContextPath, objParams.urlMensaContextPath) ? objParams.urlMensaContextPath : _this.omarSitesState.url.mensaContextPath;

      _this.omarSitesState.url.stagerContextPath = checkForValidObjProp(_this.omarSitesState.url.stagerContextPath, objParams.urlStagerContextPath) ? objParams.urlStagerContextPath : _this.omarSitesState.url.stagerContextPath;

      _this.omarSitesState.url.downloadContextPath = checkForValidObjProp(_this.omarSitesState.url.downloadContextPath, objParams.urlDownloadContextPath) ? objParams.urlDownloadContextPath : _this.omarSitesState.url.downloadContextPath;

      _this.omarSitesState.url.kmlContextPath = checkForValidObjProp(_this.omarSitesState.url.kmlContextPath, objParams.urlKmlContextPath) ? objParams.urlKmlContextPath : _this.omarSitesState.url.kmlContextPath;

      _this.omarSitesState.url.jpipContextPath = checkForValidObjProp(_this.omarSitesState.url.jpipContextPath, objParams.urlJpipContextPath) ? objParams.urlJpipContextPath : _this.omarSitesState.url.jpipContextPath;
