<div ng-controller = "FilterController as filter">
    <div ng-controller = "ReachbackController as reachback">
            ...
            <div class = "container-fluid">
                ...
                <div class = "collapse navbar-collapse" id = "map-navbar-collapse">
                    <ul class = "nav navbar-nav col-md-4">
                        ...
                        <li ng-show="reachback.reachbackEnabled" role = "presentation">
        ...
        <div class="row">
            ...
            <div class = "col-md-8">
                <div class = "tab-content">
                    ...
                    <div role ="tabpanel" class = "tab-pane" id = "reachbackSearch">
                        <div class = "row">
                            <%-- KEYWORD FILTERS --%>
                            <div class = "col-md-4">
                                <div class = "row">
            ...
            <div class = "col-md-4">
                ...
                <div class = "ResultsPane" ng-hide="filterVideosToggle" id = "reachbackPanelContainer" >
                    ...
                    <div class = "JSONPanel">
                        <div class="resultsInfo"><h4 id="JSONInfo">Showing {{ reachback.reachbackResponse.length }} results</h4></div>
                        <pre class="reachbackPanel">{{ reachback.reachbackResponse | json }}</pre>
                    </div>
                </div>
            </div>
